...
import com.portfolio.dsendra.Dto.dtoEducacion;
import com.portfolio.dsendra.Entity.Educacion;
import com.portfolio.dsendra.Security.Controller.Mensaje;
import com.portfolio.dsendra.Service.Seducacion;
...
public class CEducacion {
    ...
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody dtoEducacion dtoeducacion){
        ...
        if(StringUtils.isBlank(dtoeducacion.getNombreE())){
            return new ResponseEntity(new Mensaje("debes rellenar este campo "), HttpStatus.BAD_REQUEST);
        }
